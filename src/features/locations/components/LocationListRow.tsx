...
export function LocationListRow({
  ...
  return (
    <div className="group flex items-center justify-between p-3 sm:p-4 bg-card/60 backdrop-blur-sm border border-border/60 rounded-2xl shadow-sm hover:shadow-md hover:shadow-primary/5 hover:border-primary/30 transition-all duration-300 gap-4">
      {/* Left: Icon & Details */}
      <div className="flex items-center gap-4 flex-1 min-w-0">
        <div className="shrink-0 w-10 h-10 rounded-xl bg-secondary/80 flex items-center justify-center border border-border/50 group-hover:bg-primary/10 group-hover:border-primary/20 transition-colors">
